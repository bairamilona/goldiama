...
function ImageTheEagleOfTrust() {
  return (
    <div className="relative shrink-0 size-[340px]" data-name="Image (The Eagle of Trust)">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImageTheEagleOfTrust} />
    </div>
  );
}
...
function Picture() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px relative w-full" data-name="Picture">
